...
import io.github.nosequel.core.util.command.data.CommandData;
import io.github.nosequel.core.util.command.data.SubcommandData;
import lombok.Data;
...
public class CommandController implements Controller {
    ...
    public CommandController(String fallbackPrefix) {
        ...
        this.typeAdapters.addAll(Arrays.asList(
                ...
                new RankTypeAdapter(),
                new ChatColorTypeAdapter(),
                new CorePlayerTypeAdapter()
        ));
    }
     ...
     */
    public CommandController registerCommand(Object... objects) {
